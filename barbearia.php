...
<head>
  <title>Agendar Serviço | BarberFlow</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
  ...
  <?php
  $aberturaMin = isset($aberturaFormat[0]) ? $aberturaFormat[0] : '00';
  $aberturaSec = isset($aberturaFormat[1]) ? $aberturaFormat[1] : '00';
  $fechamentoMin = isset($fechamentoFormat[0]) ? $fechamentoFormat[0] : '00';
  $fechamentoSec = isset($fechamentoFormat[1]) ? $fechamentoFormat[1] : '00';
  ...
  echo "
    <script>
        ...
        $('.timepicker').pickatime({
            ...
            min: [$aberturaMin, $aberturaSec],
            max: [$fechamentoMin, $fechamentoSec]
        })
    </script>
";
