    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="campaign" id="chartLucros"></div>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Exibição do Lucro Diário PHP -->
<div class="row mt-4">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Lucro Diário</h4>
                <p class="card-subtitle">Lucro total para hoje:</p>
                <h2>
                    <?php
...
<!-- Exibição do Total de Serviços para o Dia PHP -->
<div class="row mt-4">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Total de Serviços para o Dia</h4>
                <p class="card-subtitle">Número total de serviços para hoje:</p>
                <h2>
                    <?php
