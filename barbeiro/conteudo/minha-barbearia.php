                    ...
                    <form method="post" action="./minha-barbearia" class="example-form">
                        <section class="example-section row">
                            <div class="col-md-7 div-sobre">
                                ...
                                <br>
                                <textarea name="sobreBarber" class="form-control is-invalid" id="validationTextarea" placeholder="Ex. Tenho uma bela e requisitada barbearia." [required]="isEdit" rows="6"><?php echo $bar['sobre_barber']; ?></textarea>
                                <button name="sobre" type="submit" class="btn btn-primary mt-3">Salvar Alteração</button>
                            </div>
                            <div class="col-md-4">
                                <h2>Sua melhor foto
                                ...
                                <div>
                                    <img class="img-thumbnail" width="200" src="../assets/images/cliente-sem-ft.png">
                                </div>
                ...
                <form method="post" action="./minha-barbearia" class="example-form">
                    <div class="row pt-1 pb-1 mb-2">
                        <div class="col-md-4" style="text-align: center;">
                            ...
                            <input name="nome_barbearia" type="text" disabled class="form-control" value="<?php echo $bar['nome_barbearia']; ?>">
                        </div>
                        <div class="col-md-4" style="text-align: center;">
                            <label>Usuário</label>
                            <input name="nome_dono" type="text" disabled class="form-control" value="<?php echo $bar['nome_dono']; ?>">
                        </div>
                        <div class="col-md-4" style="text-align: center;">
                            <label>Email</label>
                            <input name="email_dono" type="text" disabled class="form-control" value="<?php echo $bar['email_dono']; ?>">
                        </div>
                    </div>
                    <div class="row pt-1 pb-1 mb-2">
                        <div class="col-md-4" style="text-align: center;">
                            <label>Estado</label>
                            <input name="uf" type="text" disabled class="form-control" value="<?php echo $bar['uf']; ?>">
                        </div>
                        <div class="col-md-4" style="text-align: center;">
                            <label>Cidade</label>
                            <input name="cidade" type="text" disabled class="form-control" value="<?php echo $bar['cidade']; ?>">
                        </div>
                        <div class="col-md-4" style="text-align: center;">
                            <label>CEP</label>
                            <input name="cep" class="form-control" maxlength="9" disabled placeholder="Ex. 00000-000" #cep value="<?php echo $bar['cep']; ?>">
                        </div>
                    </div>
                    <div class="row pt-1 pb-1 mb-2">
                        <div class="col-md-8" style="text-align: center;">
                            <label>Endereço</label>
                            <input name="bairro" type="text" disabled class="form-control" value="<?php echo $bar['bairro'] . ', ' . $bar['rua']; ?>">
                        </div>
                        <div class="col-md-4" style="text-align: center;">
                            <label>Número</label>
                            <input name="number" id="input" type="number" disabled class="form-control" value="<?php echo intVal($bar['num_bar']); ?>" />
                        </div>
                    </div>
                    <input name="id" style="visibility: hidden;" type="text" value="<?php echo $bar['barbearia_id'] ?>">
                    <div style="text-align: end;">
                        <button name="salvar" id="editar" onclick="editarInfo();" type="button" class="btn btn-primary" style="width: 33%;">Editar</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <div class="profile-a">
                    <form method="post" action="./minha-barbearia" class="example-form">
                        <section class="example-section">
                            ...
                            <div style="text-align: end;">
                                <button value="<?php echo $bar['barbearia_id'] ?>" name="aplicar" class="mt-5 btn btn-primary" style="width: 33%;">Aplicar</button>
                            </div>
                        </section>
                    </form>
                </div>
